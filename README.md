...
* Clone the forked repository to your local machine: git clone https://github.com/YOUR_USERNAME/Farm-Android.git
* Navigate to the repository directory: cd Farm-Android
